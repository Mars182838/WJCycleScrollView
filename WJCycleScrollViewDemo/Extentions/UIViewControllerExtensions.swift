...
extension UIViewController {
    ...
    /** TextFeildNotification */
    public func addTextFieldTextDidChangeNotification(){
        
        self.addNotificationObserver(UITextFieldTextDidChangeNotification, selector: #selector(UIViewController.textFieldTextDidChangeNotification(_:)))
    }
    ...
    public func removeTextFieldTextDidChangeNotification(){
        
        self.removeNotificationObserver(UITextFieldTextDidChangeNotification)
     }
    ...
    public func textFieldTextDidChangeNotification(notify: NSNotification){
